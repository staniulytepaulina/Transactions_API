...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="API_Transactions",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16API_Transactions11AppDelegate")
...
SWIFT_CLASS("_TtC16API_Transactions13SceneDelegate")
...
SWIFT_CLASS("_TtC16API_Transactions15TransactionCell")
...
SWIFT_CLASS("_TtC16API_Transactions14TransactionsVC")
@interface TransactionsVC : UIViewController
- (void)viewDidLoad;
...
@interface TransactionsVC (SWIFT_EXTENSION(API_Transactions)) <UITableViewDataSource>
